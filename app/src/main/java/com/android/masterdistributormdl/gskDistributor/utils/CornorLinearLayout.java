...
public class CornorLinearLayout extends LinearLayout {
    ...
    public CornorLinearLayout(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    public CornorLinearLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public CornorLinearLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public void setBackgrounColor(Integer color) {
