...
import com.android.masterdistributormdl.databinding.Services4Binding
...
class Services4 : Fragment() {
    lateinit var model: Services1Model
    private lateinit var binding: Services4Binding

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?
    ): View {
        binding=
            DataBindingUtil.inflate(inflater, R.layout.services4, container, false)
