...
import com.android.masterdistributormdl.databinding.NotiInfoBinding
...
class NotiInfo : Fragment() {
    lateinit var model: NotiInfoModel
    private lateinit var binding: NotiInfoBinding
    ...
    override fun onCreateView(
        ...
        binding =
            DataBindingUtil.inflate(inflater, R.layout.noti_info, container, false)
        model = ViewModelProvider(this)[NotiInfoModel::class.java]
        binding.model = model
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val item = requireArguments().getSerializable("data") as PushItem
        binding.title.text = item.type_status
        binding.body.text = item.message
        binding.time.text = indiaTimeFormat(item.create_dt)
    }


}

class NotiInfoModel(application: Application) : AndroidViewModel(application) {
