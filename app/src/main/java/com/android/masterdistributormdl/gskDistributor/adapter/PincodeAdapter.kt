...
import com.android.masterdistributormdl.gskDistributor.distributor.AddDistributorModel
...
class PincodeAdapter(val model: AddDistributorModel?, var viewType: Int) :
