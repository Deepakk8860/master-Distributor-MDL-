...
import com.android.masterdistributormdl.cropper.CropOverlayView.CropWindowChangeListener
 ...
 * Large Bitmaps Efficiently](http://developer.android.com/training/displaying-bitmaps/load-bitmap.html).
    ...
    open class CropResult internal constructor(
        ...
        fun getUriFilePath(context: Context, uniqueName: Boolean = true): String? =
