...
import com.android.masterdistributormdl.utils.DEVICE_ID
import com.android.masterdistributormdl.utils.DEVICE_NAME
...
import com.android.masterdistributormdl.utils.latitude
import com.android.masterdistributormdl.utils.longitude
        ...
        try {
            ...
            if (status == 100 && !alreadyRedirected) {
                ...
                Handler(Looper.getMainLooper()).post {
                    val intent = Intent(application, MaintenanceMsgActivity::class.java)
